...
namespace RedisHelperLib
{
    public static class StackExchangeRedisHelper
    {
        ...
        /// <returns></returns>
        public static string MergeKey(string key,int headtype = -1)
        {
            return BaseSystemInfo.GetKeyHead(headtype) +key;
        }
        #region String
        /// <summary>
        /// 根据key获取缓存对象
        ...
        public static bool SortSetAdd<T>(String key, T value, object Score, When when = When.Always, CommandFlags flags = CommandFlags.None)
        {
           return GetDatabase().SortedSetAdd(key, Serialize(value), Convert.ToDouble(Score), when, flags);
        }
        ...
        /// <param name="value"></param>
        /// <param name="flags"></param>
        public static bool SetAdd<T>(String key, T value, CommandFlags flags = CommandFlags.None)
        {
            return GetDatabase().SetAdd(key, Serialize(value), flags);
        }
       ...
       public  static byte[] Serialize(object o)
        ...
        /// </summary>
        /// <param name="p"></param>
        public static List<T> GetSetValues <T>(int bcode,int startindex,int endindex)
        {
    ...
    internal class BaseSystemInfo
    {
        ...
        internal static readonly string SystemCode_0 = "000B";
        internal static readonly string SystemCode_1 = "000C";
        internal static readonly string SystemCode_2 = "000D";
        internal static readonly string SystemCode_3 = "000E";
        internal static readonly string SystemCode_4 = "000F";
        internal static readonly string SystemCode_5 = "000G";
    }
}
